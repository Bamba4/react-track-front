...
const Register = ({ classes, setNewUser }) => {
  ...
  return (
    <div className={classes.root}>
              ...
              (createUser, {loading, error}) => {
                  return (
                    <form onSubmit={event => handleSubmit(event, createUser)} className={classes.form}>
                        ...
                        <Button disabled={loading || !username.trim() || !email.trim() || !password.trim()} className={classes.submit} type='submit' fullWidth variant='contained' color='secondary'>
                            {loading ? "Registering..." : "Register"}
                        </Button>
                        <Button onClick={() => setNewUser(false)} color='primary' variant='outlined' fullWidth>Previous use Log in here</Button>
                        {
      ...
      {/* Success Dialog */}
      <Dialog open={open} TransitionComponent={Transition} disableBackdropClick={true}>
          <DialogTitle>
              <VerifiedUserTwoTone className={classes.icon}>New Account</VerifiedUserTwoTone>
          </DialogTitle>
          <DialogContent>
